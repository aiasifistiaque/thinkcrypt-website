...
export const AboutUs = {
	ABOUT_DESCRIPTION: `At thinkcrypt.io, we offer a complete range of services that build up
					...
					right to the creation of the product itself. At thinkcrypt.io, we
					offer a complete range of services that build up business value, from
					the initial idea and formulation of product strategy, through building`,
};
