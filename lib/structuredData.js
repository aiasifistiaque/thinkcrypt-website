...
export const getOrganizationStructuredData = () => {
	return {
		...
		url: 'https://thinkcrypt.io',
		logo: 'https://thinkcrypt.io/logo.png',
		description:
...
export const getWebsiteStructuredData = () => {
	return {
		...
		potentialAction: {
			'@type': 'SearchAction',
			target: 'https://thinkcrypt.io/search?q={search_term_string}',
...
export const getLocalBusinessStructuredData = () => {
	return {
		'@context': 'https://schema.org',
		'@type': 'LocalBusiness',
		'@id': 'https://thinkcrypt.io/#localbusiness',
		name: 'ThinkCrypt',
		alternateName: 'ThinkCrypt Technologies',
		description:
...
export const getArticleStructuredData = article => {
	return {
		...
		publisher: {
			...
			logo: {
				'@type': 'ImageObject',
				url: 'https://thinkcrypt.io/logo.png',
			},
		},
		...
		mainEntityOfPage: {
			'@type': 'WebPage',
			'@id': `https://thinkcrypt.io/blog/${article.slug}`,
		},
