export const courseData = {
	...
	shortDescription: `Elevating your impact as a resilient, strategic leader
Embark on our Basic Web Development Bootcamp and dive into the fundamentals of modern web development. Learn HTML, CSS, JavaScript, and more to kickstart your journey in creating dynamic websites.`,
	courseInfo: [
		{
			title: 'Duration',
			value: '8 Weeks',
	...
	duration: '8 Weeks',
	timeCommitment: 'Onsite',
	location: 'Banani, Dhaka',
	price: 'BDT 13,000',

	bootcampDetails: {
		heading: 'everything in one bootcamp',
		description:
		...
		photo: '/course/courseDetails/main.jpg',
		items: [
			{
			...
			},
			{
				...
				subline: `Career support provides guidance on job search, resume building, interview preparation, and networking to secure employment opportunities.`,
			},
			{
				title: 'peer practice',
				subline:
			...
			{
				title: 'weekly assesment',
				subline: `Weekly assessments evaluate your progress, identify areas for improvement, and provide valuable feedback to enhance your learning experience.`,
			},
			{
				title: 'one to one mentor',
				subline: `One-to-one mentorship offers personalized guidance, skill enhancement, and goal achievement through direct support from an experienced mentor.`,
			},
			{
				title: 'recorded sessions',
				subline: `Recorded sessions allow you to revisit course content, review key concepts, and reinforce your learning at your own pace and convenience.`,
			},
		],
	},
	quote: {
		quoteText: `“I truly believe that this has been the most transformative development experience that I have had as a leader so far. Speaking to like-minded peers helped me to open myself up and to connect with my sense of self and purpose on a deeper level.”`,
		author: `The Great Anamee`,
	},
	techStack: [
		`/stack/xd.svg`,
		`/stack/nextjs.svg`,
	...
	learnings: [
		{
			icon: '/learnings/computer.svg',
			description: `Learn from industry professionals with years of experience, ensuring you receive top-tier education`,
		},
		{
			icon: '/learnings/document.svg',
			description: `Gain hands-on experience with real-world projects, preparing you for the challenges of the job market. `,
		},
		{
			icon: '/learnings/network.svg',
			description: `Receive tailored guidance and feedback to refine your skills and maximize your potential`,
		},
		{
			icon: '/learnings/cell.svg',
			description: `Access courses online, allowing you to learn at your own pace and schedule`,
		},
		{
			icon: '/learnings/chart.svg',
			description: `Benefit from resume workshops, interview preparation, and internship opportunities to jumpstart your career`,
		},
		{
			icon: '/learnings/creativity.svg',
			description: `Join a vibrant community of learners, where collaboration and networking opportunities abound`,
		},
		{
			icon: '/learnings/calendar.svg',
			description: `Learn from industry professionals with years of experience, ensuring you receive top-tier education`,
		},
	],
	faq: {
		image: '/course/faq/faq.jpg',
		questions: [
			{
				question: 'How Does the whole process work?',
				answer: `The process is simple. Fill out our online application form, and our admissions team will guide you through the rest of the process.`,
			},
			{
				question: 'What are the job placement opportunities?',
				answer: `We offer career guidance, resume building, and interview preparation support to help you land your dream job after completing the bootcamp.`,
			},
			{
				question: 'How can I communicate with Instructor?',
				answer: `You can communicate with your instructor through our online platform, where you can ask questions, seek guidance, and receive feedback on your work.`,
			},
			{
				question: 'Will I receive a certificate after completion?',
				answer: `Yes, upon successful completion of the bootcamp, you will receive a certificate that demonstrates your skills and knowledge in web development. This certificate can be a valuable asset when applying for jobs.`,
			},
		],
	},
	aboutProgram: [
	...
	bootcampSchedule: {
		...
		schedules: [
			...
			{
				id: '04',
				title: 'Practical Web design using figma',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
			...
			{
				id: '10',
				title: 'CSS Frameworks: Introduction to Tailwind/SCSS',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
			...
			{
				id: '11',
				title: 'CSS Frameworks: Advanced Tailwind/SCSS',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
					...
					{
						title: 'Project Integration and Optimization',
						subline:
			...
			{
				id: '12',
				title: 'Website Hosting - Publishing website onto the web',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
					...
					{
						title: 'Managing and Maintaining Your Website',
						subline:
			...
			{
				id: '22',
				title: 'Project: Building a Personal Website',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
					...
					{
						title: 'Implementing HTML and CSS',
						subline:
			...
			{
				id: '23',
				title: 'Professional Development: Building an Effective Resume',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
			...
			{
				id: '24',
				title: 'Professional Development: Preparing for Job Interviews',
				subline: '3 Class, 1 Assesment',
				duration: '2 Hours',
				items: [
					{
	...
	benefitsOfBootcamp: {
		...
		photo: '/course/course.png',
		items: [
			{
				point: 'Foundational Knowledge',
				body: 'Master essential languages like HTML, CSS, and JavaScript, laying a solid groundwork for web development.',
			},
			{
				point: 'Dynamic Web Development',
				body: 'Learn to build interactive and responsive websites, enhancing user experience and engagement.',
			},
			{
				point: 'Versatility',
				body: 'Acquire skills applicable across industries, from e-commerce to blogging, opening diverse career paths.',
			},
			{
				point: 'Portfolio Building',
				body: 'Create a robust portfolio of projects, showcasing your expertise to potential employers or clients.',
			},
			{
				point: 'Career Opportunities',
				body: 'Access a wide range of job roles, from front-end developer to web designer, with competitive salaries.',
			},
		],
	},
};
