					...
					<GridItem>
						<Column
							...
							<Text
								...
								lineHeight={1.6}>
								A simple and feature-rich inventory and e-commerce solution that integrates
								seamlessly with your business operations. Built by our trusted partner, MINT is a
								cutting-edge application designed to streamline inventory management, invoicing,
								billing, and customer engagement—all in one platform
							</Text>
							<Text
								fontFamily={fonts.Michroma}
								fontSize={{ lg: '1rem', xl: '1.25rem' }}
